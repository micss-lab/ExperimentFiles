...
public class ScalerAgentEnvironment  {
...
//	static Logger logger = Logger.getLogger(Network.class.getName());
  ...
  //  	turnScope = String.valueOf(args[1]); //2000.0;
   // 	textName= turnScope+String.valueOf(args[2]);
    ...
    //    textName= turnScope+"_boolean_";
		...
		URL path = getClass().getResource("Workload_250-500_Iteration1.txt");  // File in the same package
       ...
       // MapDataPath = "C:\\Users\\Burak\\eclipse-workspace_earlier\\networkScaler\\src\\java\\inputs\\"+turnScope+"\\Workload_"+turnScope+"_Iteration"+turn+".txt"; // Change this to your file path
		...
		System.out.println("THE PATH IS: "+getClass().getResource(this.toString()));
    	

    	
    	
    	 loadValuesFromFile("C:\\Users\\Burak\\OneDrive - Universiteit Antwerpen\\Images\\Hichem Boot" +
				 "\\7_9_21\\template_project_gradlecopie\\template-project\\src\\main\\java\\JadeNetworkScaler\\Workload_250-500_Iteration1.txt");
 ...
 /*   public boolean executeAction(String ag, Structure action) {
	...
	public void scaleFactor(int scaleFactorParam) {
    ...
    public void getWorkLoadBool () {
    	...
    	ScalerAgent.arrivedWorkload = workLoad;
	...
	//	removePerceptsByUnif(ag,Literal.parseLiteral("arrivedTurn(_)"));
		...
		ScalerAgent.arrivedTurn = arrivalTurns;
   ...
   // 	Literal literal_currentWorkLoad = Literal.parseLiteral("currentWorkLoad("+workLoad+")");
	//	addPercept(ag, literal_currentWorkLoad);
		...
		ScalerAgent.currentWorkLoad = workLoad;
		
		
		int remainingTurns = netsc.arrivalTurnsBackCounter();


		ScalerAgent.arrivedTurn = remainingTurns;
