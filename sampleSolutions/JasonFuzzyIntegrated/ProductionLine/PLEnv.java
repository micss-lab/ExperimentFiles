...
//	static EV3MediumRegulatedMotor pushmotor = null;
	...
	public static final Term sampleColorRule = Literal.parseLiteral("sampleColorRule");  
	
	public static final Term sampleColorRuleAuto = Literal.parseLiteral("sampleColorRuleAuto"); 
	...
	// GoRedPosition()
        ...
        // Output file path
        String outputFilePath = "C:\\Users\\Burak\\OneDrive - Universiteit Antwerpen\\Bureaublad\\Activities\\Publications\\TSF\\Case Studies\\Production Line\\OutputFiles\\WCET\\FuzzyORJ_Normal.txt";
...
//	public static final Literal senseDrop = Literal.parseLiteral("senseDrop");
   ...
   //   String inputFilePath = "C:\\Users\\Burak\\OneDrive - Universiteit Antwerpen\\Bureaublad\\Activities\\Publications\\TSF\\Case Studies\\Production Line\\OutputFiles\\Randoms\\SampleInputEnhanced.txt";
     
	
 	String inputFilePath = "/home/robot/productionLineEmpirical/src/java/SampleInputEnhanced.txt";
...
//		        }
	   ...
	   private void fuzzyColourSensorRule() throws InterruptedException {	 	
           ...
           System.out.println(" 1111111111111 "+red+" "+green+" "+blue);
           
          
           
      	   rule_fuzzification(red, green, blue);
		   
	   }

	   private void fuzzyColourSensorRule_auto() throws InterruptedException {	 	
		...
		rule_fuzzification_auto(red, green, blue);
	...
	//	   System.out.println("colorReadinggg");
	   ...
	   private static final String newLine = System.getProperty("line.separator");
		 ...
		 public  void rule_fuzzification (float red, float green, float blue) {
			...
			// Red fuzzy membership functions
				...
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(low,_)"));
				Literal literal_redLow = Literal.parseLiteral("colorRed(low," + redLow + ")");
				...
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(medium,_)"));
				Literal literal_redMid = Literal.parseLiteral("colorRed(medium," + redMid + ")");
				addPercept("sortAgent", literal_redMid);

				double redHigh = trape(60.0, 115.0, 255.0, 255.0, red);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(high,_)"));
				Literal literal_redHigh = Literal.parseLiteral("colorRed(high," + redHigh + ")");
				addPercept("sortAgent", literal_redHigh);

			// Green fuzzy membership functions
				double greenLow = trian(0.0, 0.0, 20.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(low,_)"));
				Literal literal_greenLow = Literal.parseLiteral("colorGreen(low," + greenLow + ")");
				addPercept("sortAgent", literal_greenLow);

				double greenMid = trian(0.0, 20.0, 30.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(medium,_)"));
				Literal literal_greenMid = Literal.parseLiteral("colorGreen(medium," + greenMid + ")");
				addPercept("sortAgent", literal_greenMid);

				double greenHigh = trian(20.0, 30.0, 50.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(high,_)"));
				Literal literal_greenHigh = Literal.parseLiteral("colorGreen(high," + greenHigh + ")");
				addPercept("sortAgent", literal_greenHigh);

				double greenVeryHigh = trian(30.0, 50.0, 80.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(veryhigh,_)"));
				Literal literal_greenVeryHigh = Literal.parseLiteral("colorGreen(veryhigh," + greenVeryHigh + ")");
				addPercept("sortAgent", literal_greenVeryHigh);

				double greenUltraLow = trian(50.0, 80.0, 110.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(ultralow,_)"));
				Literal literal_greenUltraLow = Literal.parseLiteral("colorGreen(ultralow," + greenUltraLow + ")");
				addPercept("sortAgent", literal_greenUltraLow);

				double greenUltraMedium = trian(80.0, 110.0, 145.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(ultramedium,_)"));
				Literal literal_greenUltraMedium = Literal.parseLiteral("colorGreen(ultramedium," + greenUltraMedium + ")");
				addPercept("sortAgent", literal_greenUltraMedium);

				double greenUltraHigh = trape(110.0, 145.0, 255.0, 255.0, green);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(ultrahigh,_)"));
				Literal literal_greenUltraHigh = Literal.parseLiteral("colorGreen(ultrahigh," + greenUltraHigh + ")");
				addPercept("sortAgent", literal_greenUltraHigh);

			// Blue fuzzy membership functions
				double blueLow = trian(0.0, 0.0, 10.5, blue);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(low,_)"));
				Literal literal_blueLow = Literal.parseLiteral("colorBlue(low," + blueLow + ")");
				addPercept("sortAgent", literal_blueLow);

				double blueMid = trian(10.5, 10.5, 19.5, blue);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(medium,_)"));
				Literal literal_blueMid = Literal.parseLiteral("colorBlue(medium," + blueMid + ")");
				addPercept("sortAgent", literal_blueMid);

				double blueMax = trape(10.5, 19.5, 255.0, 255.0, blue);
				removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(high,_)"));
				Literal literal_blueMax = Literal.parseLiteral("colorBlue(high," + blueMax + ")");
				addPercept("sortAgent", literal_blueMax);

		 }

		 public void rule_fuzzification_auto(float red, float green, float blue) {
			...
			// Red fuzzy membership functions
			double redVeryLow = trian(16.42, 22.73, 77.54, red);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(verylow,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorRed(verylow," + redVeryLow + ")"));
			
			double redLow = trian(16.42, 70.49, 96.22, red);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(low,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorRed(low," + redLow + ")"));
			
			double redMedium = trian(50.93, 76.06, 119.50, red);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(medium,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorRed(medium," + redMedium + ")"));
			
			double redHigh = trian(54.96, 94.47, 157.52, red);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(high,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorRed(high," + redHigh + ")"));
			
			double redVeryHigh = trian(80.30, 124.52, 157.52, red);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorRed(veryhigh,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorRed(veryhigh," + redVeryHigh + ")"));
			
			// Green fuzzy membership functions
			double greenVeryLow = trian(18.45, 25.54, 38.10, green);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(verylow,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorGreen(verylow," + greenVeryLow + ")"));
			
			double greenLow = trian(18.45, 34.63, 54.00, green);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(low,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorGreen(low," + greenLow + ")"));
			
			double greenMedium = trian(25.02, 42.69, 121.87, green);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(medium,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorGreen(medium," + greenMedium + ")"));
			
			double greenHigh = trian(30.84, 96.34, 187.28, green);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(high,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorGreen(high," + greenHigh + ")"));
			
			double greenVeryHigh = trian(81.89, 148.04, 187.28, green);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorGreen(veryhigh,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorGreen(veryhigh," + greenVeryHigh + ")"));
			
			// Blue fuzzy membership functions
			double blueVeryLow = trian(5.81, 8.04, 12.23, blue);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(verylow,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorBlue(verylow," + blueVeryLow + ")"));
			
			double blueLow = trian(5.81, 11.12, 20.69, blue);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(low,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorBlue(low," + blueLow + ")"));
			
			double blueMedium = trian(8.03, 16.36, 32.90, blue);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(medium,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorBlue(medium," + blueMedium + ")"));
			
			double blueHigh = trian(11.82, 26.01, 37.55, blue);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(high,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorBlue(high," + blueHigh + ")"));
			
			double blueVeryHigh = trian(22.11, 29.68, 37.55, blue);
			removePerceptsByUnif("sortAgent", Literal.parseLiteral("colorBlue(veryhigh,_)"));
			addPercept("sortAgent", Literal.parseLiteral("colorBlue(veryhigh," + blueVeryHigh + ")"));
...
///////////////////////////////////////////////////////////////////////////////////////		    
	...
	//	logger.info(ag+" doing: "+ action);
        try {
            ...
            else if(action.equals(sampleColorRule)) {
            	
            	fuzzyColourSensorRule();
            }
			
			else if(action.equals(sampleColorRuleAuto)) {
            	
            	fuzzyColourSensorRule_auto();
            }
			// fuzzyColourSensorRule_auto
    ...
    */        
	 ...
	 private void saveResult(Term decisionResult, int planNumber) {
		  ...
		  dataList.get(productCounter).planNumber = planNumber;
	      ...
	      if (productCounter == dataList.size()) {
	       ...
	       //   String outputFilePath = "output.txt";
				...
				// /home/robot/productionLineFuzzy/src/java/emergencyFuzzy.txt
// 

 //  String outputFilePath = "C:\\Users\\Burak\\OneDrive - Universiteit Antwerpen\\Bureaublad\\Activities\\Publications\\TSF\\Case Studies\\Production Line\\OutputFiles\\WCET\\Orj\\output.txt";

	   String outputFilePath = "/home/robot/productionLineEmpirical/src/java/output.txt";
...
class SampleData {
    ...
    public String toString() {
        return " " + id + ", " + r + ", " + g + ",  " + b + "," + number + ",  " + color + " " + decision + " " + elapsedTime + " " + planNumber;
    }
}
