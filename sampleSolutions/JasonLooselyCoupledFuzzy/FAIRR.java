...
public class FAIRR extends Agent {
   ...
   public int buf(Collection<Literal> percepts) {
       ...
       */
       ...
       while (perceptsInBB.hasNext()) {
           ...
           Literal anmu = l.getAnnot("mu"); // here?
   ...
   */
    ...
    public Event selectEvent(Queue<Event> events) {
       ...
       // System.out.println("Select Event TE 1= "+selected.getTrigger().toString());

        if (selected.getTrigger().toString().contains("fuzzy")) {
        	
        	isFuzzyEvent = true;
        	
       //     System.out.println("Select Event TE 2= "+selected.getTrigger().toString());
...
//System.out.println("*************"+options+"*******************");
        ...
        if (options.size() > 0 && isFuzzyEvent ) //&& (!options.get(0).getPlan().getTrigger().toString().contains("-")) 
        {
            ...
            selected = super.selectOption(options);
              ...
              e.printStackTrace(); // Handle the exception properly instead of just printing it
            }
        }
        	...
        	// this should also be generated. 
        	 for (Literal belief : beliefs)
        	 {
        		 ...
        		 if (String.valueOf(belief).contains(String.valueOf(beliefParse)))
        		 {
        			 ...
        			 //System.out.println("Problem here? "+belief); // garbage(r3)[.. ?? Problem point
    ...
    protected Option selectOptionAsFuzzy(List<Option> options) throws RevisionFailedException {
     ...
     //   System.out.println("Before Relevant Plans ="+this.EventTrigger);
     //   System.out.println("Before Relevant Options ="+options);
    	
    	try {
			options = relevantPlans(this.EventTrigger,null);
      ...
      //  System.out.println("After Relevant Plans ="+this.EventTrigger);
     //   System.out.println("After Relevant Options ="+options);
