...
/*	public static final Term   nsRev = Literal.parseLiteral("next(slotRev)");
 ...
 //   public static final Literal checkStatusBool = Literal.parseLiteral("checkStatusBool");
    ...
    ArrayList<Entry<String, Long>> agentTimeList = new ArrayList<>();
...
//    }
   ...
   void updatePercepts() {
    ...
    //            + batteryStart + "_" + vacuumStart + "_" + mapNumber + "_OutBoolean.txt";
		...
		public void checkStatusBool(AgentFeatures ag)
        {
            ...
            int agNumber = Integer.parseInt(ag.name.substring(1));
        ...
        //    double vacuuumCapacity =0.0;
            ...
            if (agNumber-1==0)
            {
           	 ag.batteryCapacity = batteryR1.getCapacity();
           	 ag.vacuumCapacity = vacuumBagR1.remainingCAP;
            }
            else if (agNumber-1==2)
            {
            ag.batteryCapacity = batteryR3.getCapacity();
            ag.vacuumCapacity = vacuumBagR3.remainingCAP;
            }
		...
		//	addPercept(ag, literal_batteryMin);
			...
			if (ag.batteryCapacity > 5.0 && ag.batteryCapacity <= 10.0)
	...
	//		 removePerceptsByUnif(ag,Literal.parseLiteral("vacuumBag(_)"));
		...
		//	addPercept(ag, literal_vacuumBagMin);
			...
			//boolean vacuumBagMax = (ag.vacuumCapacity > 750.0); // true if vacuumCapacity is greater than 1000
      ...
      //      System.out.println("Check Status: "+intensityValue);
         ...
         //   removePerceptsByUnif(ag,Literal.parseLiteral("dirtIntensity(_)"));
            ...
            if (intensityValue > 30.0 && intensityValue <= 50.0) {
                // true if intensityValue is between 30.0 and 50.0
                ag.dirtIntensity = "min";
                // Literal literal_intensityMin = Literal.parseLiteral("dirtIntensity(min)");
                // addPercept(ag, literal_intensityMin);
            } else if (intensityValue > 50.0 && intensityValue <= 70.0) {
                // true if intensityValue is between 50.0 and 70.0
                ag.dirtIntensity = "mid";
                // Literal literal_intensityMid = Literal.parseLiteral("dirtIntensity(mid)");
                // addPercept(ag, literal_intensityMid);
            } else if (intensityValue > 70.0) {
                // true if intensityValue is greater than 70
                ag.dirtIntensity = "max";
...
// ##########################################################################3
        ...
        void burnGarb(AgentFeatures ag, double vacuumPowerLimit, double vacuumPowerConstant) {
            // r2 location has garbage
        	
        	String agOrj= ag.name;
            String revAgName = ag.name.substring(1);

            System.out.println("AG NAME IS "+ revAgName);
            
            int agNumber = Integer.parseInt(revAgName);
           	...
           	System.out.println("Vacuum PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPower Limit: "+ vacuumPowerLimit  +" *** Constant= "+ vacuumPowerConstant);
                ...
                /*  for (int i = 0; i < actionValues.length; i++) {
            	 ...
            	 if (agNumber-1==0)
            	 {
                     ...
                     System.out.println("REACH R1 CAPS: "+(agNumber-1) + " BatterResult: "+batteryR1.getCapacity() + " addResult: " + vacuumBagR1.remainingCAP);
			            	...
			            	if (!batteryResult)
			    	         ...
			    	         //   addPercept("r1",literal_batteryChargeStatus);
                                 ...
                                 ag.batteryPower="depleted";

                                 System.out.println("AGENT R1 BATTERY IS DEPLETED");
			               ...
			               //  	addPercept("r1",literal_vacuumBagStatus);
                                ...
                                System.out.println("AGENT R1 BAGGGG IS FULL");
		             		}
		         }
            	 ...
            	 else if (agNumber-1==2)
            	 {
                     ...
                     System.out.println("REACH R3 CAPS: "+(agNumber-1) + "BatterResult: "+batteryR3.getCapacity() + "addResult: " + vacuumBagR3.remainingCAP);
                             ...
                             if (!batteryResult)
                             {
                                 ...
                                 System.out.println("AGENT R3 BATTERY IS DEPLETED");
			                ...
			                //  	addPercept("r3",literal_vacuumBagStatus);
                                ...
                                System.out.println("AGENT R3 BAGGGG IS FULL");
		            		}
